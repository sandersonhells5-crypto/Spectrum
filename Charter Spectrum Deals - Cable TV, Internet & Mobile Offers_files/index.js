...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "1e3ea6dd7a4003258aec";
...
var apiKey = "StHLyZpfaF1li6i1AtKpW86yJEOpeg4O8I3rD9Fs";
var lyticsEndpoint = "https://fyqs98n8o6.execute-api.us-west-2.amazonaws.com/v1";
axios__WEBPACK_IMPORTED_MODULE_6___default.a.defaults.headers.post['x-api-key'] = apiKey;

function getBasicPayload(eventType) {
  var lyticsID = jstag.ckieGet('seerid');
  if (!lyticsID) lyticsID = -1; // this is checking on the website if the var providerId exist
  // eslint-disable-next-line no-undef

  var checkProviderId = function checkProviderId() {
  ...
  var checkDataStream = function checkDataStream() {
    if (typeof dataStream !== 'undefined' && dataStream !== null) {
      return dataStream;
    } else {
      return '';
    }
...
window.addEventListener('load', function (e) {
  ...
  if (params) {
    var subId = '';
    if (params.get('s1')) subId = params.get('s1');else if (params.get('subid')) subId = params.get('subid');
    var productInterest = '';
    var productInterestEl = document.getElementById('product_interest');
    if (typeof productInterestEl !== 'undefined' && productInterestEl != null) productInterest = productInterestEl.value;

    var payload = _objectSpread(_objectSpread({}, getBasicPayload('LyticsOnLoad')), {}, {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default.a.post(lyticsEndpoint, payload).catch(function (error) {
      console.log(error);
    });
  } else console.log('No load data was posted to lytics');
...
window.addEventListener('submit', function (e) {
  ...
  if (formData && (formData.get('email') || formData.get('email_address') || formData.get('QuoteEmail')) && formData.get('first_name')) {
    var payload = getBasicPayload('LyticsFormSubmit');
    payload.formSubmit = 'Form Submitted';
  ...
  } else console.log('No form data was posted to lytics');
...
(function () {
  ...
  reactHotLoader.register(apiKey, "apiKey", "E:\\ReactDeployment\\centerfield-lytics-pixel_1_9ebaecd_release%1.0.3-payload_update\\src\\js\\index.js");
  reactHotLoader.register(lyticsEndpoint, "lyticsEndpoint", "E:\\ReactDeployment\\centerfield-lytics-pixel_1_9ebaecd_release%1.0.3-payload_update\\src\\js\\index.js");
  reactHotLoader.register(getBasicPayload, "getBasicPayload", "E:\\ReactDeployment\\centerfield-lytics-pixel_1_9ebaecd_release%1.0.3-payload_update\\src\\js\\index.js");
})();
